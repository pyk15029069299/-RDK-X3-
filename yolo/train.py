...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='models/SEAttention.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default='traffic_parameter.yaml', help='data.yaml path')
